...
print("Verification errors : ", dfWorkingEntries[dfWorkingEntries["position_prediction"] != dfWorkingEntries["position_verified"]].shape[0])

joblib.dump(c, "model/role_identification_model_32bits.sav")